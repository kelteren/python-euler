...
# print(grid)
# print(grid.shape)
# print("rows:\t\t",grid.shape[0])
# print("columns:\t",grid.shape[1])
...
for i in range(0,grid.shape[0]):
	for j in range(0,grid.shape[1]):
		...
		if i < grid.shape[0]-3:
			max_product = max(max_product, prod_down(i,j))

		if j < grid.shape[1]-3:
			max_product = max(max_product, prod_right(i,j))

		if j > 2:
			max_product = max(max_product, prod_left(i,j))

		if i > 2:
			max_product = max(max_product, prod_up(i,j))

		if (i < grid.shape[0]-3) and (j < grid.shape[1]-3):
			max_product = max(max_product, prod_diag_tl_br(i,j))

		if (i < grid.shape[0]-3) and (j > 2):
			max_product = max(max_product, prod_diag_tr_bl(i,j))
